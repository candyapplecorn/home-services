...
def resolve_model_path(model: str) -> str:
    ...
    if model.startswith("/") or model.startswith("~"):
        raise FileNotFoundError(
            ...
            "Install the model there, or set AI_HELPER_MODEL to a local model directory, "
            "a Hugging Face model id, or a kaggle:// model handle."
        )
...
class ModelRunner:
    ...
    def load(self) -> None:
        ...
        model_path = resolve_model_path(self.settings.model)
    ...
    def generate(self, prompt: str) -> str:
        ...
        messages = [
            {
                "role": "system",
                "content": "You are a concise local command line assistant.",
            },
